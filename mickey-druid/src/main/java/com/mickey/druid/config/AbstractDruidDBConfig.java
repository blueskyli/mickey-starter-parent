...
public abstract class AbstractDruidDBConfig {
    ...
    @Value("${mickey.pagehelper.reasonable:false}")
    private String reasonable;
    @Value("${mickey.pagehelper.supportMethodsArguments:false}")
    ...
    private SqlSessionFactory createSqlSessionFactory(DataSource dataSource, String mapperLocations) throws Exception {
        ...
        logger.info("pagehelper参数->reasonable:{},supportMethodsArguments:{}", reasonable, supportMethodsArguments);
